# RADIUS Access-Request: Vendor-Specific (Type 26) policy injection

**Affected:** RADIUS (RFC 2865) as implemented by FreeRADIUS; lab MITM on Access-Request.  
**CWE:** CWE-345

MITM injects a VSA (`role=admin`). Server accepts it and returns attacker policy. Access-Request VSAs are not integrity-protected.
...
- CVE-2024-3596
- https://github.com/APEvul-cyber/radius_freeradius_vul/tree/main/vendor-specific
