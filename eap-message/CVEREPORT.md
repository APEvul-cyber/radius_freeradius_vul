# RADIUS Access-Request: EAP-Message (Type 79) without Message-Authenticator

**Affected:** RADIUS (RFC 2865) as implemented by FreeRADIUS; lab MITM on Access-Request.  
**CWE:** CWE-306

RFC 3579 wants Message-Authenticator on EAP. A rogue NAS that omits it is accepted on stacks that do not enforce MA. Modern FreeRADIUS rejects this; older or lax servers do not.
