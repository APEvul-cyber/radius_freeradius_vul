# RADIUS Access-Request: CHAP-Password (Type 3) offline crack

**Affected:** RADIUS (RFC 2865) as implemented by FreeRADIUS; lab MITM on Access-Request.  
**CWE:** CWE-327

CHAP is a challenge/response with no Access-Request integrity. A passive sniffer recovers weak passwords offline (`weakpass123` in the lab).
...
- CVE-2024-3596
- https://github.com/APEvul-cyber/radius_freeradius_vul/tree/main/chap-password
