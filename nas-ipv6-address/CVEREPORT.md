# RADIUS Access-Request: NAS-IPv6-Address (Type 95) identity spoof

**Affected:** RADIUS (RFC 2865) as implemented by FreeRADIUS; lab MITM on Access-Request.  
**CWE:** CWE-290

MITM replaces NAS-IPv6-Address. Policy keyed on NAS identity changes. Auth still succeeds because Access-Request is not MACed.
...
- CVE-2024-3596
- https://github.com/APEvul-cyber/radius_freeradius_vul/tree/main/nas-ipv6-address
